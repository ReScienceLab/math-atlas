...
export function VizLoader({
  ...
  if (!Viz) {
    return (
      <div
        className={`${stableClassName} bg-[var(--gray-950)] border border-white/[0.08] flex items-center justify-center text-[var(--gray-600)] text-sm`}
      >
